...
public class GalleryFragmentDirections {
  ...
  @NonNull
  public static ShowPhoto showPhoto(@NonNull Uri photoPageUri) {
    return new ShowPhoto(photoPageUri);
  }

  public static class ShowPhoto implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ShowPhoto(@NonNull Uri photoPageUri) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ShowPhoto setPhotoPageUri(@NonNull Uri photoPageUri) {
      if (photoPageUri == null) {
        throw new IllegalArgumentException("Argument \"photoPageUri\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("photoPageUri", photoPageUri);
    ...
    public boolean equals(Object object) {
      ...
      ShowPhoto that = (ShowPhoto) object;
    ...
    public String toString() {
      return "ShowPhoto(actionId=" + getActionId() + "){"
